...
-------------------------------------------------------------------------------
# Load GDO Pool and Region Information
```{r}
wd <- getwd()
wd
...
GDO200 <- read.xlsx(paste0(wd,"//preprocessed//200bp_i30.xlsx"))
GDO300 <- read.xlsx(paste0(wd,"//preprocessed//300bp_i30.xlsx"))
GDO400 <- read.xlsx(paste0(wd,"//preprocessed//400bp_i30.xlsx"))
...
topGDO200 <- pickTopGDObyStrand(numGDO, GDO200, regions200, GDO200Overlap)
topGDO300 <- pickTopGDObyStrand(numGDO, GDO300, regions300, GDO300Overlap)
topGDO400 <- pickTopGDObyStrand(numGDO, GDO400, regions400, GDO400Overlap)

## Picking guides but without filtering for strand representation.
...
Export list of top guides and all guides.
```{r}
...
write.xlsx(GDO200, file = paste0(wd, "//output//200bp_i30.xlsx"))
write.xlsx(GDO300, file = paste0(wd, "//output//300bp_i30.xlsx"))
write.xlsx(GDO400, file = paste0(wd, "//output//400bp_i30.xlsx"))
```
