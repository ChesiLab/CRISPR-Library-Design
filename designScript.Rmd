...
# Add the SNP Region
GDO200 <- left_join(guides, select(crispick200, SNP, crispick), join_by("Input"=="crispick"))
GDO300 <- left_join(guides, select(crispick300, SNP, crispick), join_by("Input"=="crispick"))
GDO400 <- left_join(guides, select(crispick400, SNP, crispick), join_by("Input"=="crispick"))
...
topGDO200 <- pickTopGDO(5, GDO200, regions200, GDO200Overlap)
topGDO300 <- pickTopGDO(5, GDO300, regions300, GDO300Overlap)
topGDO400 <- pickTopGDO(5, GDO400, regions400, GDO400Overlap)
```
