...
finalGDOOverlap <- findGDOSelfOverlap(finalGDO, "chr","start","end",selfBool = TRUE)
...
posA30 <- left_join(posA30, refseqLookup, join_by("Reference.Sequence"=="refseq"))
...
```{r}
write.xlsx(topPos, file = paste0(wd, "//output//top3_promoter_i30.xlsx"))
```
